...
# publish.sh - Automated publishing script for mcp-dataiku
# Features: Build, version update, publish, push code and tags

set -e  # Exit immediately on error

echo "🚀 Starting automated publishing process for mcp-dataiku..."

# 1. Build project (skip tests)
...
# 2. Get current version and update patch version
...
echo "🔗 GitHub Release will be created automatically at: https://github.com/steven0lisa/mcp-dataiku/releases"
echo ""
echo "You can install the new version with:"
echo "npm install @zhangzichao2008/mcp-dataiku@$NEW_VERSION"